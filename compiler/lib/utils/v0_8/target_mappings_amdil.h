...
static const TargetMapping AMDILTargetMapping_0_8[] = {
  ...
  { "CI", "Tiran",      "owls",    amd::GPU_Library_CI,        CI_TIRAN_P_A0,           F_SI_BASE, true, true, FAMILY_CI },
  { "CI", "Maui",       "eagle",   amd::GPU_Library_CI,        CI_MAUI_P_A0,            F_SI_BASE, true, true, FAMILY_CI },
#else
  UnknownTarget,
  UnknownTarget,
#endif
