...
static const TargetMapping HSAILTargetMapping_0_8[] = {
  ...
  { "CI", "Tiran",     "GFX7", amd::GPU_Library_HSAIL, CI_TIRAN_P_A0,   F_VI_BASE, true, true,  FAMILY_CI },
  { "CI", "Maui",      "GFX7", amd::GPU_Library_HSAIL, CI_MAUI_P_A0,    F_VI_BASE, true, true,  FAMILY_CI },
#else
  UnknownTarget,
  UnknownTarget,
#endif
